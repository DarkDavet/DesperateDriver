...
## Key features
* Architecture: implemented state pattern for decoupled systems, including car handling states, ice cream quality stages, and player reputation logic.
